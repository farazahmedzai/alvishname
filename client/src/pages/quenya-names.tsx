...
export default function QuenyaNames() {
  ...
  return (
    <div className="min-h-screen bg-elvish-dark text-elvish-light font-inter antialiased">
      ...
      <SchemaManager 
        pageType="quenya" 
        title="Quenya Name Generator - Free High Elvish Names from LOTR"
        description="Generate authentic Quenya (High Elvish) names from Valinor. Free LOTR name generator with meanings and pronunciations. Perfect for D&D characters and fantasy writing."
      />
